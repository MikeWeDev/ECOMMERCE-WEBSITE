    ...
    const {click,handle} = props;
     return (
      <div className="overflow-hidden">
         <Slider />
          <Catagory />
  <div className="flex flex-wrap justify-between bg-[rgba(0,0,0,0.1)] align-center mt-[50px] ">
    {datas.map((iteam)=>(
            <>
            <div key={iteam.id}
             className="box-container hover:scale-110 hover:bg-[#ff5e5e] hover:shadow-2xl  hover:shadow-black mt-[22px]
               md:w-[22%] md:gap-6  relative
           w-[40%]  border-[rgba(0,0,0,0.2)] border-[2px] gap-2 ">
